...
ln -s ~/opt/dotfiles/main-kimbo/.config/compton.conf ~/.config/compton.conf
ln -s ~/opt/dotfiles/main-kimbo/.config/dunst/dunstrc ~/.config/dunst/dunstrc
...
ln -s ~/opt/dotfiles/main-kimbo/.ssh/config ~/.ssh/config
